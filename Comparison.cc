...
/*
char *Comparision::GetNameWithoutTable(char* name)
{
	string strTemp;
	...
	for (int whichAnd = 0; 1; whichAnd++, parseTree = parseTree->rightAnd) {
		...
		for (int whichOr = 0; 1; whichOr++, myOr = myOr->rightOr) {
			...
			if (myOr->left->left->code == NAME) {
				...
				if (leftSchema->Find (value) != -1) {
					cnf.orList[whichAnd][whichOr].operand1 = Left;
					cnf.orList[whichAnd][whichOr].whichAtt1 =
						leftSchema->Find (value);	
					typeLeft = leftSchema->FindType (value);

				// see if we can find it in the right schema
				} else if (rightSchema->Find (value) != -1) {
                                        cnf.orList[whichAnd][whichOr].operand1 = Right;
                                        cnf.orList[whichAnd][whichOr].whichAtt1 =
                                                rightSchema->Find (value);
                                        typeLeft = rightSchema->FindType (value);
			...
			// literal record that stores all of the comparison values
				...
				AddLitToFile (numFieldsInLiteral, outRecFile, outSchemaFile, value, String);
				typeLeft = String;
			...
			// see if it is an integer
				...
				cnf.orList[whichAnd][whichOr].operand1 = Literal;
				cnf.orList[whichAnd][whichOr].whichAtt1 = numFieldsInLiteral;
				AddLitToFile (numFieldsInLiteral, outRecFile, outSchemaFile, value, Int);
				typeLeft = Int;
			...
			// see if it is a double
				...
				cnf.orList[whichAnd][whichOr].operand1 = Literal;
				cnf.orList[whichAnd][whichOr].whichAtt1 = numFieldsInLiteral;
				AddLitToFile (numFieldsInLiteral, outRecFile, outSchemaFile, value, Double);
				typeLeft = Double;
			...
			if (myOr->left->right->code == NAME) {
				...
				if (leftSchema->Find (value) != -1) {
					...
					cnf.orList[whichAnd][whichOr].whichAtt2 =
						leftSchema->Find (value);	
					typeRight = leftSchema->FindType (value);
				...
				// see if we can find it in the right schema
                                        ...
                                        cnf.orList[whichAnd][whichOr].whichAtt2 =
                                                rightSchema->Find (value);
					typeRight = rightSchema->FindType (value);
	...
	for (int whichAnd = 0; 1; whichAnd++, parseTree = parseTree->rightAnd) {
		...
		for (int whichOr = 0; 1; whichOr++, myOr = myOr->rightOr) {
			...
			if (myOr->left->left->code == NAME) {
				...
				if (mySchema->Find (value) != -1) {
					cnf.orList[whichAnd][whichOr].operand1 = Left;
					cnf.orList[whichAnd][whichOr].whichAtt1 =
						mySchema->Find (value);	
					typeLeft = mySchema->FindType (value);
			...
			if (myOr->left->right->code == NAME) {
				...
				if (mySchema->Find (value) != -1) {
					...
					cnf.orList[whichAnd][whichOr].whichAtt2 =
						mySchema->Find (value);	
					typeRight = mySchema->FindType (value);
