...
public:
	...
	void PrintToFile (Schema *mySchema, ofstream &o) ;

	// This is added by Christan Grant for project 3
	// This is the same as Print but it takes an open file pointer
	// and writes to that location
	void Print2File (Schema* mySchema, FILE* _out);
